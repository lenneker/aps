    ...
    <div class="d-flex align-items-center justify-content-between col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6 col-xxl-6 gap-3">
         ...
         <div class="card w-50 shadow position-relative">
            <div class="card-body d-flex flex-column">
                <h5 class="card-title"><strong>Denúncias<br>abertas</strong></h5>
                <p class="card-text">Veja as denúncias em aberto.</p>
        ...
        <div class="card w-50 shadow position-relative">
            <div class="card-body d-flex flex-column">
                <h5 class="card-title"><strong>Histórico<br>de denúncias</strong></h5>
                <p class="card-text">Veja todo o histórico de denúncias.</p>
                <a href="../../admin-area/admin-ticket-history.php" class="btn btn-secondary mt-auto">Histórico de denúncias</a>
                <div class="position-absolute top-0 end-0 mt-2 me-2">
