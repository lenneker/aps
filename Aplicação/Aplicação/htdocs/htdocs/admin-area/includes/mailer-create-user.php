...
function sendTicketClosedEmail($user_email, $id, $description, $resolution_justification, $attendant)
{
    ...
    try {
        ...
        $mail->SMTPAuth = true;
        $mail->Username = 'admin@unitaengenharia.com.br'; 
        $mail->Password = '?4t+00T@fG$]63-`0Kd+PgO@F8W|dQ^H$wd\.87tCHRS"56)1o'; // Senha SMTP
        $mail->SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS;
        $mail->Port = 587;

        $mail->setFrom('admin@unitaengenharia.com.br');
        $mail->addAddress($user_email); 
        //$mail->addCC('suporte.ti@unitaengenharia.com.br');
        ...
        $mail->isHTML(true);
        $mail->Subject = 'CONCLUSÃO DA DENÚNCIA - PROTOCOLO #' . htmlspecialchars($id) . ' - CONTROLE & TI';
